        ...
        return SystemTable.<ShardRowContext>builder(IDENT, RowGranularity.SHARD)
            ...
            .startObject("recovery")
                ...
                .startObject("source_node")
                    .add("id", STRING, s -> s.recoverySourceNode() == null ? null : s.recoverySourceNode().getId())
                    .add("name", STRING, s -> s.recoverySourceNode() == null ? null : s.recoverySourceNode().getName())
                .endObject()
                .startObject("target_node")
                    .add("id", STRING, s -> s.recoveryTargetNode() == null ? null : s.recoveryTargetNode().getId())
                    .add("name", STRING, s -> s.recoveryTargetNode() == null ? null : s.recoveryTargetNode().getName())
                .endObject()
